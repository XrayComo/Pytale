...
def menu(screen):
    ...
    dialog = ['Python is aggressive',
              "You tried to talk",
              "Python doesn't pay attention",
    ...
    while True:
        ...
        text = font.render("ENHP :" + str(enemyhp), True, (255, 255, 255))
        text_rect = text.get_rect()
        text_rect = (400, 0)
        screen.blit(text, text_rect)

        font = pygame.font.SysFont("calibri", 20)
        text = font.render("HP :" + str(health), True, (255, 255, 255))
        text_rect = text.get_rect()
        text_rect = (10, 10)
        screen.blit(text, text_rect)
...
def attack(screen):
    ...
    b = (Ball(150, 180, 35, 35, "enemy.png", 5, 5, 5))
    ...
    while True:
        ...
        if random.randint(1, 100) < 5:
            enemy = {'x': 0, 'y': random.randint(0, 500), 'speed': random.randint(1, 5)}
        ...
        if player.rect.x < 105:
            player.rect.x = 106
        if player.rect.x > 370:
            player.rect.x = 369
        if player.rect.y < 168:
            player.rect.y = 168
        if player.rect.y > 434:
            player.rect.y = 434
...
def attack2(screen):
    ...
    while True:
        ...
        # Згенеруємо нового ворога
        if random.randint(1, 100) < 5:
            enemy = {'x': random.randint(0, 500), 'y': 0, 'speed': random.randint(1, 5)}
            enemies.append(enemy)
...
def attack1(screen):
    ...
    while running:
        ...
        if random.randint(1, 100) < 2:
            enemy = {'x': 0, 'y': 400, 'speed': random.randint(1, 5)}
            enemies.append(enemy)
...
def attack4(screen):
    ...
    while running:
        ...
        # Згенеруємо нового ворога
        if random.randint(1, 100) < 2:
            enemy = {'x': SCREEN_WIDTH, 'y': 400, 'speed': random.randint(1, 5)}
            enemies.append(enemy)
...
def attack5(screen):
    ...
    while True:
        ...
        # Згенеруємо нового ворога
        if random.randint(1, 100) < 5:
            enemy = {'x': random.randint(0, 500), 'y': random.randint(0, 500), 'speed_x': 0, 'speed_y': 0}
